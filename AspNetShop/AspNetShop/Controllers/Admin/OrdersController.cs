...
namespace OnlineShop.Web.Controllers.Admin
{
    public class OrdersController : Controller
    {
        ...
        public OrdersController(AspNetShopContext context)
        {
            _context = context;
        }
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public async Task<IActionResult> Edit(Guid id, [Bind("IsPayed,PaymentUrl,DeliveryAddress,OrderStatus,Id,CreationDate,DeletedDate")] Order order)
        {
            if (id != order.Id)
            {
                return NotFound();
